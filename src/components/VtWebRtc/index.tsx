...
export default class VtWebRtc extends Vue {
  dialogVisible = false;
  timeInterval = 3000;
  mediaRecorder: any;
  ...
  render() {
    return (
      this.dialogVisible &&
      <el-dialog visible={this.dialogVisible} class="vtx-webRtc">
        <div ref="videosContainer" class="vtx-webRtc__video-container">
          <video class="vtx-webRtc__video" ref="video"></video>
          {
            this.isRec &&
            [
              <span class="vtx-webRtc__isRec"></span>,
              <span class="vtx-webRtc__isRec-big"></span>,
              <span class="vtx-webRtc__recTime">{this.videoTime}</span>,
            ]
          }
        ...
        <div class="vtx-webRtc__footer">
          <el-button type="primary" onClick={this.start} disabled={this.isRec}>开始录制</el-button>
          <el-button type="primary" onClick={this.stop} >停止录制</el-button>
          <el-button type="primary" onClick={this.save} >下载</el-button>
          <el-button type="primary" onClick={this.hide} >关闭</el-button>
        </div>
      </el-dialog>
    )
  }
  ...
  save() {
    this.mediaRecorder && this.mediaRecorder.save();
    this.stop();
  }

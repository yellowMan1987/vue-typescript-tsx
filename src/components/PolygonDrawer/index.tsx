...
export const DEFAULT_POLYGON_LINE_WEIGHT = 2;
export const DEFAULT_POLYGON_LINE_OPACITY = 1;
export const DEFAULT_POLYGON_LINE_CONNECT_POINT_RADIUS = 2;
export const DEFAULT_POLYGON_MASK_OPACITY = 0.3;
